...
class Cache {
    ...
    public function connect($type='',$options=array()) {
        ...
        $class  =   strpos($type,'\\')? $type : 'system\\driver\\cache\\'.ucwords(strtolower($type));
    ...
    protected function queue($key) {
        ...
        $queue_name =   isset($this->options['queue_name'])?$this->options['queue_name']:'hd_queue';
